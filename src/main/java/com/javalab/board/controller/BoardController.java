 ...
 * 	 @Controller 어노테이션이 붙은 클래스들으 빈으로 등록한다.
...
public class BoardController {
	 ...
	 * 3) @Autowirde + @Qualifier("이름")
	 * 4) @Resource(name = "이름") : 자바 제공
	 */
	// 1. @Autowired (BoardDao -> BoardServiceImpl)로 변경
	@Autowired
...
//	private BoardDao dao;
	 ...
	 *  - 어플리케이션이 구동되면서 핸들러 매핑은 어떤 url과 메소드가 연결되어 있는지
	 *    정보를 모두 취합해서 Map 형태로 갖고 있다.url(key - 메소드명(value)) 
	 */
